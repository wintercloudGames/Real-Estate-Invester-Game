...
func update_ui():
	$VBoxContainer/properties.text = "Property's: " + add_comma_to_int(Globals.Propertys)
	$VBoxContainer/Net_worth.text = "Total Property Value: " + add_comma_to_int(Globals.net_worth)
